    ...
    <div className="Home">
        <header className="Home-header">
            ...
            <div className="grid grid-cols-4 grid-gap">
                <a href="https://tiktok.com/@futureproofso" target='_blank'>
                ...
                <a href="https://twitter.com/futureproofso" target='_blank'>
                ...
                <a href="https://linkedin.com/company/future-proof-collective" target='_blank'>
                ...
                <a href="https://github.com/futureproofso" target='_blank'>
