      ...
      <div className="Home-content">
        ...
        <div className="grid grid-cols-5 grid-gap">
          <a
            ...
            href="https://tiktok.com/@futureproofso"
            target="_blank"
          >
            <svg
          ...
          <a
            className="link external"
            href="https://twitter.com/futureproofso"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="link external"
            href="https://linkedin.com/company/future-proof-collective"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="link external"
            href="https://github.com/futureproofso"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
